...
// Função para exibir produtos (somente Camisas)
function displayProducts() {
    fetch(API_URL)
        ...
        .then(produtos => {
            ...
            // Filtra os produtos com o tipo "Camisa"
            const camisas = produtos.filter(item => item.tipo === "Camisa");
...
window.onload = () => {
    displayProducts(); // Apenas camisas serão exibidas
