...
// Função para exibir produtos (somente Sapatos)
function displayProducts() {
    fetch(API_URL)
        ...
        .then(produtos => {
            ...
            // Filtra os produtos com o tipo "Sapato"
            const sapatos = produtos.filter(item => item.tipo === "Sapato");
            ...
            document.querySelectorAll('.add-to-cart').forEach(button => {
                button.addEventListener('click', event => {
                    // Garantir que estamos pegando os dados do botão correto
...
function updateCartCount() {
    ...
    // Atualizar a quantidade no botão do carrinho
...
window.onload = () => {
    displayProducts(); // Apenas sapatos serão exibidos
